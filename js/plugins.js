  ...
  ;((t.buildStyleTag = function () {
    ...
    (t.hydrateModal = function (o) {
      ...
      ;((document.getElementById(t.prefix('-button-1')).href =
        ...
        (document.getElementById(t.prefix('-button-4')).href =
          'mailto:' + e + '?subject=' + i + '&cc=' + n + '&bcc=' + l + '&body=' + a),
    ...
    (t.modalFocus = function () {
      ;((i.focusableChildren = Array.from(
        i.querySelectorAll('a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])')
      )),
    ...
    (t.enablePageScrolling = function (i) {
      i
        ? (e.classList.remove(t.prefix('-no-scroll')), o.classList.remove(t.prefix('-no-scroll')))
        : (e.classList.add(t.prefix('-no-scroll')), o.classList.add(t.prefix('-no-scroll')))
    }),
            ...
            for (
              ...
              if (a.slidesPerColumn > 1) {
                ...
                if ('row' === a.slidesPerColumnFill && a.slidesPerGroup > 1) {
                  ...
                  ;((O =
                    (A = N - (D = Math.floor(N / B)) * B + G * a.slidesPerGroup) + (D * C) / P),
                    I.css({
...
!(function (n, e) {
  ...
  function m(n, e) {
    for (
      var t = n.length, r = arguments.length >= 2 ? arguments[1] : void 0, a = [], o = 0;
      o < t;
      o++
    )
      if (o in n) {
